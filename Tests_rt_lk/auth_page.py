...
class AuthPage(WebPage):
    ...
    auth_btn_vk = WebElement(id='oidc_vk')
    auth_btn_ok = WebElement(id='oidc_ok')
    auth_btn_mail = WebElement(id='oidc_mail')
    auth_btn_google = WebElement(id='oidc_google')
    auth_btn_ya = WebElement(id='oidc_ya')
